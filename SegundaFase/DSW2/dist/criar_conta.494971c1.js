document.addEventListener('DOMContentLoaded', ()=>{
    ...
    async function buscarEndereco(cep) {
        try {
            ...
            alert("CEP n\xe3o encontrado. Por favor, verifique o CEP digitado.");
            return null;
        }
    }
    ...
    document.getElementById('cep').addEventListener('blur', async (event)=>{
        ...
        if (cep.length === 8) await preencherEndereco(cep);
    });
    ...
    formCadastro.addEventListener('submit', async (event)=>{
        ...
        try {
            ...
            alert("Erro ao cadastrar usu\xe1rio. Tente novamente.");
        }
    });
...
//# sourceMappingURL=criar_conta.494971c1.js.map
